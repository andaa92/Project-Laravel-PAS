    ...
    <div class="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100">
        <div class="container mx-auto px-4 py-8">
            ...
            <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
                <div>
                    <h1 class="text-3xl font-semibold text-blue-800">Daftar Mata Pelajaran</h1>
                    <p class="text-blue-600 mt-1">Kelola mata pelajaran sekolah</p>
                </div>
                                ...
                                <tr class="hover:bg-blue-50 transition">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            ...
                                            <div class="ml-4">
                                                <div class="text-sm font-medium text-blue-800">{{ $mp->nama }}</div>
                                            </div>
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <div class="flex space-x-2">
                                            <a href="{{ route('mata-pelajaran.edit', $mp->id) }}"
